...
/**
 * A BaseType<T> keeps track of the base data type of a tensor in a way that allows the Java type
 * system to use it for type checking. There is a separate BaseType<T> object for each of the
 * possible data types, corresponding to the cases of the enum DataType.
 *
 * @param <T>
 */
