...
public class TensorTest {
  ...
  public void createWithByteBuffer() {
    ...
    try (Tensor<Byte> t = Tensor.create(strings)) {
  ...
  public void writeTo() {
    ...
    try (Tensor<Integer> tints = Tensor.create(ints);
        Tensor<Float> tfloats = Tensor.create(floats);
        Tensor<Double> tdoubles = Tensor.create(doubles);
        Tensor<Long> tlongs = Tensor.create(longs);
        Tensor<Boolean> tbools = Tensor.create(bools)) {
  ...
  @Test
  public void scalars() {
    try (Tensor<Float> t = Tensor.create(2.718f)) {
    ...
    try (Tensor<Double> t = Tensor.create(3.1415)) {
  ...
  public void nDimensional() {
    ...
    try (Tensor<Boolean> t = Tensor.create(fourD)) {
      assertEquals(DataType.BOOL, t.dataType());
  ...
  public void failOnArbitraryObject() {
    try (Tensor<Integer> t = Tensor.create(new Object())) {
